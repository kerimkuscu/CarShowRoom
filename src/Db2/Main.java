...
public class Main extends Application
{
    ...
    private void salesmanActivity(Scene backScene, String userid) //Todo---------------- salesmanActivity()
    {
        ...
        try
        {
            ...
            showAllCustomer_bt.setOnAction(showAllCars_bt_e ->
            {
...
//                search_bt
    ...
    private void managerActivity(Scene backScene, String userid)
    {
...
//                search_bt
    ...
    private void carBrowserActivity(Scene backScene)
    {
